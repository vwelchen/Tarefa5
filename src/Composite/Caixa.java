...
public class Caixa implements Item {
	...
	// Armazena tanto Folha como Contêiner, por isso deve ser declarado com um tipo
	...
	// Como os filhos do Contêiner passam essas chamadas para seus próprios filhos e
	// assim em diante,
